...
{
   public class ListContentViewComponent : ViewComponent
   {
      public IViewComponentResult Invoke(BooksListViewModel viewModel)
      {
         return View("_ListContentPartialView", viewModel);
      }
   }
}